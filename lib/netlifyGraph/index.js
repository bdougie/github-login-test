...
const operationsDoc = `query FindGitHubUserIdForReal($login: String!) @netlify(id: """e85fa83f-351a-4828-803d-3db70ff93828""", doc: """Query to find user id info from github""") {
  gitHub {
    user(login: $login) {
      id
      databaseId
...
export const fetchFindGitHubUserIdForReal = (
      variables,
      options
    ) => {
      return fetchNetlifyGraph({
        query: operationsDoc,
        operationName: "FindGitHubUserIdForReal",
        variables: variables,
        options: options || {},
      });
    }
...
export const fetchMyGitHubUserId = (
      variables,
      options
    ) => {
      return fetchNetlifyGraph({
        query: operationsDoc,
        operationName: "MyGitHubUserId",
        variables: variables,
        options: options || {},
      });
    }
...
const functions = {
  ...
  */
  fetchFindGitHubUserIdForReal: fetchFindGitHubUserIdForReal,
  /**
  * An example query to start with.
  */
  fetchMyGitHubUserId: fetchMyGitHubUserId
}
